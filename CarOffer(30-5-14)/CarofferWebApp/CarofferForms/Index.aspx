...
<%--<head runat="server">
    ...
    <head id="Head1" runat="server">
		...
		<!-- HEADER -->
                ...
                <!-- Main Navigation -->
                <div class="nav-wrapper topadjust" style="margin-top:-3px">
                	<div class="container">
                    	<div class="row">
                        	<div class="span12">
                ...
                <!-- Special Offer -->
               	<div class="specialoffer-wrapper">
               	  ...
               	  <div class="col-md-3 arowxsd" ><ul class="ca-menu"><div class="number"><img src="../Images/1.png" style="width:66px ;height:66px"/></div>
               	      <li >
                        <a href="#">
                            <span class="ca-icon" style="margin-top:5%;">Submit Vehicle Identification Number</span>
               	      ...
               	      <li>
                        <a href="#">
                            <span class="ca-icon" style="margin-top:10%;"> Enter Car Details</span>
               	      ...
               	      <li>
                        <a href="#">
                            <span class="ca-icon" style="margin-top:7%;">  Receive TheCarOffer Within 48 Hours</span>
                            <div class="ca-content"></div>
                        </a>                   
                    </li>
               	      ...
               	      <li>
                        <a href="#">
                            <span class="ca-icon" style="margin-top:11%;">Sell Us Your Car!</span>
                            <div class="ca-content"></div>
                        </a>                   
                    </li>
                ...
                <div class="row searhareaoffercar"><div class="container"><div class="col-sm-6"><input id="vintxt" name="vintxt" placeholder="Enter VIN here" type="text" style="font-size:26px" class="carossersearchfield" runat="server"  required/></div><div class="col-sm-1"></div><div class="col-sm-3" style="text-align:center;"><asp:ImageButton ID="imgbtn" runat="server" ImageUrl="../Images/get.png" style="width:300px" OnClick="imgbtn_Click" /><%--<img src="../Images/get.png" style="width:300px"/>--%></div></div></div>
      ...
      <p style="text-align:center;">Thousands of new cars, trucks and crossovers. All with amazing deals.</p></td>
                ...
                <div class="footer-widget-wrapper">
                	<div class="container">
                    	<div class="row">
                            ...
                            <div class="col-md-3">
                            <div class="span3 f-widget" style="margin-left:25%;">
                ...
                <script type="text/javascript">
                   // $('input[name=').prop('required', true);
                    function MovtoCaroffer() {
                        alert('enetred into carofer');
                        if ($('vintx').val() == '') {
                            alert("enter VIN");
